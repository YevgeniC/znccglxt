	...
	<div id="body">
	        ...
	        <div id="menu">
	            ...
	            <c:forEach var="Library" items="${Library}">
		            <tr>
		                <td width=100 height=50><c:out value="${Library.pid}"></c:out></td>
		                ...
		                <form action="/ssm/delete" method="post">
		                	<input type="hidden" name="pid" value="${Library.pid}">
		                	<input type="submit" value="删除" class="button">
		                </form>
		                <form action="/ssm/move" method="post">
		    				<input type="hidden" name="pid" value="${Library.pid}">
		                	<input type="submit" value="移动" class="button" style="color:#28D5B7">
						</form>
		                </td>
		            </tr>
		        </c:forEach>
