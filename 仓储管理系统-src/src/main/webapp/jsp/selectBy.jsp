...
<body>
	<div id="body">
	            ...
	            <c:forEach var="Library" items="${Library}">
		            <tr>
		                ...
		                <td width=100 height=50>
		                	...
		                	<button type="button" class="button" onclick="OutLib(${Library.pid})" style="color:#28D5B7">移动</button>
		                </td>
		            </tr>
		        </c:forEach>
		    </table>
		    ...
		    %> 
		   	 共<%=count%>条记录 |
		    <a href="/ssm/selectBy.do?page=${page-1}">上一页</a> | 
		    <a href="/ssm/selectBy.do?page=${page+1}">下一页</a> | 
		  	第${page}页 |
		   	 共 <%=totalpage%>页
<!--             <table> -->
<!--                 <tr> -->
