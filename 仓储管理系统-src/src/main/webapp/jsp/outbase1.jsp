...
<body>
	<div id="body">
	        <div id="top">
	            <form action="outbase1by" method="get" id="form" name="form1">
	            	<input type="radio" name="type" value="0" checked="checked" style="position:relative; width:15px; height:15px; top:15px;">
	            ...
	            <c:forEach var="Library" items="${Library}">
		            <tr>
		                ...
		                <td width=100 height=50>
		                	<form action="/ssm/chuli" method="post">
		                	<input type="hidden" name="pid" value="${Library.pid}">
		                	<input type="hidden" name="pname" value="${Library.pname}">
				              <input type="hidden" name="pnum" value="${Library.pnum}">
				              <input type="hidden" name="fisid" value="${Library.fisid}">
				               <input type="hidden" name="secid" value="${Library.secid}">
				               <input type="hidden" name="thiid" value="${Library.thiid}">
		                	<input type="submit" value="出库" class="button">
		                	</form>
	        ...
	        <div id="button"><a href="outbaseselectall" style="color:#FFF">查看出库单</a></div>
	        <div id="end">
	        <% int count = (Integer)request.getAttribute("count");
  		    	int totalpage = (Integer)request.getAttribute("totalpage"); 
		    %> 
		   	 共<%=count%>条记录 |
		    <a href="/ssm/outbase1.do?page=${page-1}">上一页</a> | 
		    <a href="/ssm/outbase1.do?page=${page+1}">下一页</a> | 
		  	第${page}页 |
		   	 共 <%=totalpage%>页	
