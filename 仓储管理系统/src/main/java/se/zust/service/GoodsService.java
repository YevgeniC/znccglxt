...
public interface GoodsService {
	...
	List<Goods> selectGoods(String pid, String pname, String area, String room, String startTime, String endTime, int start, int pageSize);

	int selectGoodsCount(String pid, String pname, String area, String room, String startTime, String endTime);
